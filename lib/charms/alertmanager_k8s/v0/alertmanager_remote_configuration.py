...
class RemoteConfigurationProvider(Object):
    ...
    def load_initial_alertmanager_config_to_relation_data_bag(
        ...
        inside relation data bag. If needed, it can be used by `alertmanager-remote-configuration`
    ...
    def _alertmanager_config(self) -> dict:
        ...
        if remote_configuration_relation and remote_configuration_relation.app:
            try:
                raw_config = remote_configuration_relation.data[remote_configuration_relation.app][
                    "alertmanager_config"
                ]
    ...
    def _config_is_valid(config: dict) -> bool:
        ...
        by the `alertmanager-remote-configuration` consumer is valid.
...
class RemoteConfigurationConsumer(Object):
    ...
    def _on_relation_event(self, event: Union[RelationJoinedEvent, RelationChangedEvent]) -> None:
        """Event handler for remote configuration relation events.
    ...
    def _update_relation_databag(self, relation: Optional[Relation]) -> None:
        ...
        If Alertmanager config is not available, relation data is not being set.
        ...
        if self.alertmanager_config:
            ...
            relation.data[self._charm.app]["alertmanager_config"] = json.dumps(  # type: ignore[union-attr]  # noqa: E501
